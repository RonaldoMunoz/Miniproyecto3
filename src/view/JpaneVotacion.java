...
public class JpaneVotacion extends javax.swing.JPanel {
        ...
        private void initComponents() {
                ...
                jLabelVotosName.setText(
                                "Digite la cantidad de votos de: " + controlador.getCandidato(index).getNombre());
                jButtonVotosAdd.setBackground(java.awt.Color.lightGray);
                jButtonVotosAdd.setIcon(
                                new javax.swing.ImageIcon(getClass().getResource("imageSources/garrapata.png"))); // NOI18N
                ...
                layout.setVerticalGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 349,
                                                          Short.MAX_VALUE));
        }

        private String getVotos() {
                return jTextFVotos.getText();
        }

        private void setNombre(String nombre) {
                jLabelVotosName.setText("Digite la cantidad de votos de: " + nombre);
        }
